...
legCritInjuries=[
    ...
    CritInjury(-1,1,"Torn Tendon","Extreme pain, treat all stats as 1 less, you cannot succeed athletics checks or take the sprint action",allNegative=1),
    ...
    CritInjury(-1,0,"Incomplete Fracture","DV:15 athletics or fall prone immediately. Until treated, if this leg is dealt any more damage, it becomes a broken leg")
]

armCritInjuries=[
    CritInjury(-1,2,"Dismembered Arm","Your arm is unrecoverable, treat as broken arm, and is not removed upon a successful surgery check",attackPenalty=5),
    CritInjury(-1,2,"Dismembered Hand","Your hand is unrecoverable, it cannot be used whatsoever, this effect is not removed upon a successful surgery check",attackPenalty=5),
    ...
    CritInjury(-1,1,"Punctured Artery","You begin bleeding out, you bleedout twice as fast",bleedMultiplier=2),
    CritInjury(-1,1,"Foreign Object","Whenever you take an action using this arm, take 2 damage direct to body (this ignores btm and triggeres a stun check)"),
    ...
    CritInjury(-1,0,"Incomplete Fracture","Drop whatever this hand is holding. Until treated, if this arm is dealt any more damage, it becomes a broken arm")
]

torsoCritInjuries=[
    CritInjury(-1,2,"Spinal Injury","You immediately fall unconcious until a successful surgery check is performed on you, you have -1 body permanently (this cannot be undone)"),
    CritInjury(-1,2,"Pierced Heart","You begin bleeding out, you bleedout four times as fast",bleedMultiplier=4),
    CritInjury(-1,2,"Broken Ribs","Searing pain, treat all stats as 3 less, after this is removed, you retain -1 body for a week",allNegative=3),
    ...
    CritInjury(-1,1,"Pierced Liver","Stun and uncon checks are 3 harder, you cannot pass resist drugs/torture or endurance checks, violently painful",stunUnconPenalty=3),
